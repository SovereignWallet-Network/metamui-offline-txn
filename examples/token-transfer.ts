 ...
 */
 ...
 import { construct, decode, deriveAddress, getRegistry, methods, METAMUI_TYPES } from '../src';
 ...
 async function main(): Promise<void> {
   ...
   const senderNonce: any = await api.rpc.system.accountNextIndex(alice.address);
   registry.register(METAMUI_TYPES);
   // Now we can create our `tokens.transfer` unsigned tx. The following
